...
if __name__ == "__main__":
    ...
    # habitat_config = hm3d_config(stage='val',episodes=args.eval_episodes, max_steps=1000000)
    ...
    id_dict = {
        ...
        "./dependencies/habitat-lab/data/scene_datasets/hm3d_v0.2/train/00669-DNWbUAJYsPy/DNWbUAJYsPy.basis.glb":["tv_monitor"],

...
from env_tools.data_utils import hm3d_config, init_gt_sensor
...
if __name__=="__main__":
    ...
    if(args.is_llm==2):
        ...
        # val_note = "_two_dim_small_thre_one_rgb_large_bs_train_val"
        # val_note = "_two_dim_small_thre_one_rgb_large_bs_train_val_rgb_new_framework"
    ...
    for temp_pre_model in range(30, 80000, 20):
        ...
        # experiment_details = "graph_object_goal_navigation_adjacent_GAT_2024_12_27_11_17_18_four_dim_small_thre_one_rgb_large_bs"
        ...
        for index_in_episodes in range(30):
            ...
            if(args.is_gt==True):
                vln_sim = init_gt_sensor(habitat_env)
        ...
        # writer.add_scalar('Val_Result/reward', (Evaluate.success_num*40+(-1)*Evaluate.all_front_steps/Evaluate.max_front_steps_per_rl_step+Evaluate.all_dis_shape/5)/30, temp_pre_model)

...
def request_llm(rgb_image_ls, object_text):
    ...
    request_image_ls[0], request_image_ls[1], request_image_ls[2], request_image_ls[3],
    request_image_ls[0], request_image_ls[1], request_image_ls[2], request_image_ls[3],
    ...
    question_ls[2], question_ls[2], question_ls[2], question_ls[2],
    question_ls[3], question_ls[3], question_ls[3], question_ls[3]]
    ...
    answer_ls = [max(num_answer_ls[0:4]), max(num_answer_ls[4:8]), max(num_answer_ls[8:12]), max(num_answer_ls[12:16])]
    return answer_ls

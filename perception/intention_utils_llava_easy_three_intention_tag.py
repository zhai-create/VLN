...
def request_llm(rgb_image_ls, object_text, image_index_ls):
    ...
    # ====================> 2. prompt_process <====================
    # --------------------> 2.1 room_1 <--------------------
    qs_room_1 = "Infer whether the {} is in the current room, and output 1 if it is, otherwise output 0.".format(object_text)
    ...
    answer_ls = [output_room_score_ls]
    return answer_ls
...
# print(request_llm(rgb_image_ls, object_text="plant", image_index_ls=[0]))
# end_time = time.time()
